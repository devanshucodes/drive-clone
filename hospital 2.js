...
a.controller("data", function ($scope, $http, $log) {
  $http.get("https://10.21.84.127:8000/medera/doctor/register",{withCredentials: true})
...
a.controller("data", function ($scope, $http, $location) {
    $scope.func = function () {
      ...
      var obj = { mail: email, pass1: pass, pass2: cpass, user: user, phone: phoneno, fname: fname, lname: lname, dob: dob, college: college, degree: degree, gender: gender }
  
      console.log(obj);
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/doctor/register",
...
a.controller("drop", function ($scope, $http, $log) {
  $http.get("https://10.21.84.127:8000/:8000/medera/doctor/register",{withCredentials: true})
    .then(function (response) {
...
a.controller("datap", function ($scope, $http, $location) {
  $scope.func = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/patient/register",
      data: JSON.stringify(obj),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("loginp", function ($scope, $http, $location) {
  $scope.func = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/patient/login",
      data: JSON.stringify(obj),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("loginr", function ($scope, $http, $location) {
  $scope.func = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/reception/login",
      data: JSON.stringify(obj),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("patient", function ($scope, $http, $location) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/patient/home",
  ...
  $scope.logout = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/patient/logout",
      data: JSON.stringify({ "user": username }),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("appointment", function ($scope, $http, $log, $filter) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/doctor/getdoctor",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
  ...
  $scope.appoint = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/patient/appointment",
      // data: JSON.stringify({ "user": username }),
...
a.controller("login", function ($scope, $http, $location) {
  $scope.func = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/doctor/login",
      data: JSON.stringify(obj),
      withCredentials: true,
...
a.controller("doctor", function ($scope, $http, $location) {
  ...
  $http({
    method: "GET",
    url: "https://10.21.84.127:8000/medera/doctor/doctordetail",
    withCredentials: true,
 })
// $http.get("https://10.21.84.127:8000/medera/doctor/doctordetail",{withCredentials: true})
    .then(function (response) {
      // var name = localStorage.getItem("a");
      console.log(response.data);
      $scope.userdata = response.data;
    ...
    $scope.signout = function () {
      ...
      //   }
      // })
      $http.get("https://10.21.84.127:8000/medera/doctor/logout",{withCredentials: true})
        .then(function (response) {
          console.log(response.status);
          if (response.status == 200) {
...
a.controller("pendingapp", function ($scope, $http, $location) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/doctor/pending",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
    ...
    })
  {
    ...
    $scope.myFunc = function () {
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/doctor/delappointment",
        // data: JSON.stringify({ "user": username }),
    ...
    $scope.myFunct = function () {
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/doctor/approve",
        // data: JSON.stringify({ "user": username }),
        data: JSON.stringify({ 'id': $scope.id }),
        withCredentials: true,
        //  data: JSON.stringify(response.data),
...
a.controller("booked", function ($scope, $http, $location) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/doctor/booked",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
...
a.controller("receprofile", function ($scope, $http) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/reception/confirm",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
    ...
    })
  {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/reception/logout",
      data: JSON.stringify({ "user": username }),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("alldoc", function ($scope, $http, $location) {
  $scope.submit = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/reception/d1",
...
a.controller("allpat", function ($scope, $http, $location) {
  $scope.submit = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/reception/allpatient",
...
a.controller("docpre", function ($scope, $http, $location) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/reception/d2",
  ...
  $scope.prescription = function () {
    ...
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/doctor/updateprescription",
      data: JSON.stringify(obj),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
...
a.controller("medicalhistory", function ($scope, $http, $log) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/patient/mhistory",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
...
a.controller("prescription", function ($scope, $http, $log) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/patient/prescription",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
...
a.controller("payment", function ($scope, $http, $log) {
  ...
  $http({
    method: "POST",
    url: "https://10.21.84.127:8000/medera/patient/pay",
    data: JSON.stringify({ "user": username }),
    withCredentials: true,
    header: {
      "Content-Type": "application/json"
    ...
    })
  {
    $scope.myPay = function () {
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/reception/payment",
        // data: JSON.stringify({ "user": username }),
        data: JSON.stringify({ 'id': $scope.id }),
        withCredentials: true,
        //  data: JSON.stringify(response.data),
...
a.controller("update", function ($scope, $http, $location) {
    ...
    })
  {
    $scope.update = function (index) {
      ...
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/doctor/req",
        data: JSON.stringify(obj),
        withCredentials: true,
        header: {
          "Content-Type": "application/json"
...
a.controller("appup", function ($scope, $http, $location, $filter) {
    ...
    })
  {
    $scope.updat = function () {
      ...
      $http({
        method: "POST",
        url: "https://10.21.84.127:8000/medera/doctor/updateappointments",
        data: JSON.stringify(obj),
        withCredentials: true,
        header: {
          "Content-Type": "application/json"
...
a.controller("details", function ($scope, $http) {
  $scope.doc = function () {
    $http({
      method: "POST",
      url: "https://10.21.84.127:8000/medera/reception/doctorname",
      // data: JSON.stringify({ "id": id }),
      withCredentials: true,
      header: {
        "Content-Type": "application/json"
  ...
  $scope.patient = function () {
    ...
    $http({
      ...
      // $http.post("https://10.21.84.127:8000/medera/reception/d2", 
      .then(function (response) {
